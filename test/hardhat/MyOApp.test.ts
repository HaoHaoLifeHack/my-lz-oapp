...
describe('MyOApp Test', function () {
    ...
    beforeEach(async function () {
        ...
        console.log(`$EndpointA: ${mockEndpointV2A.address}`)
        console.log(`$EndpointB: ${mockEndpointV2B.address}`)
        ...
        console.log(`$OAPPA: ${myOAppA.address}`)
        console.log(`$OAPPB: ${myOAppB.address}`)
        ...
        console.log(`$A peer: ${await myOAppA.peers(eidB)}`)
        console.log(`$B peer: ${await myOAppB.peers(eidA)}`)
    })
